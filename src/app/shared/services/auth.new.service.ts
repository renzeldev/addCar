...
export class AuthService extends BaseService {
  ...
  public loggedUserRoles: UserRoles [];
  ...
  public isUserInRole(includesRole: UserRoles): boolean {
    if (this.loggedUserRoles) {
      return this.loggedUserRoles.includes(includesRole);
    } else
    {
      this.doLogoutUser();
      return false;
  ...
  public getJwtToken() {
    ...
    if (login_data_string) {
      ...
      if (login_data) {
        ...
        this.loggedUserRoles = login_data.roles;
  ...
  private doLoginUser(tokens: LoginData, remember) {
    ...
    this.loggedUserRoles = tokens.roles;
